const translations = {
  en: {
    ...
    ctaNotOpen: 'Registration opens soon ♡',
    ctaClosed: 'Registration is closed',
    registerTitle:
    ...
    countdownOpensLabel: 'Registration opens in:',
    countdownOpening: 'Opening now!',
    ...
    errorNotOpen: 'Registration has not opened yet. Please come back later.',
  ...
  es: {
    ...
    ctaNotOpen: 'El registro abre pronto ♡',
    ctaClosed: 'El registro ya está cerrado',
    registerTitle:
    ...
    countdownOpensLabel: 'El registro abre en:',
    countdownOpening: '¡Abriendo ahora!',
    ...
    errorNotOpen: 'El registro aún no ha abierto. Vuelve más tarde.',
